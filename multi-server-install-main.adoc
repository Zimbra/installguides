...
installation process for Installing Zimbra MTA on a Server on
page 48. After Step 8, configure the Zimbra-proxy. TODO - link
...
--
+
Return to the MTA section, Step 8 on page 51 to continue the MTA
server installation. TODO link
...
link)  on
page 32 to open a SSH session to the server, log on to the server as
