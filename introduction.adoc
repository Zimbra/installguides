...
ifndef::z9[A {product-short} license is required to create accounts on servers running {product-name} {product-edition-commercial}. You cannot install {product-name} Network Edition without a license.]

ifdef::z9[You cannot install {product-name} {product-version} without a license.]
