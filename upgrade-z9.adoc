...
Be sure to read the link:https://wiki.zimbra.com/index.php?title=Zimbra_Releases/8.7.0[release note] information before upgrading.
...
[source, bash]
----
su - zimbra #switch user to zimbra
zmmailboxdctl restart #Restart mailbox service as a Zimbra user
----
