...
* Zimbra Touch Client, Zimbra Mobile Client, and Zimbra HTML (Standard) Client are no longer a part of Zimbra Collaboration V9.0.0 (Beta).
...
** It is recommended that the {modern-client} is set as the default web client. Even after selecting a default, the {modern-client} and the {web-client} can be used simultaneously by users as per their choice.
