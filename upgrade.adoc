...
* {product-name} {product-version} is a beta release, it is not recommended to install or upgrade this release in a production environment. The beta release is for demo and evaluation purposes. 
* Zimbra Touch Client, Zimbra Mobile Client, and Zimbra HTML (Standard) Client are no longer a part of {product-name} {product-version}.
* {product-name} {product-version} currently does not support Rolling Upgrades. It will be supported in the upcoming releases.
...
** To know more about highlights of the Modern Web Client, please refer to the *What's New* document for {product-name} {product-version}.
** Classic Web Client offers the same functionalities as offered by the Advanced Web Client in  {product-name} 8.8.15 version.
** Modern Web Client does not currently support features like Personas, Briefcase, and Dumpster. Some of these features are part of upcoming releases. To view the detailed comparison of features supported in Modern Web Client, please refer to *Web Client Comparison* document.
...
You might need to perform the following tasks before you
upgrade. After you review the tasks in this section, please go to Upgrade
Instructions. Be sure to read the
https://wiki.zimbra.com/index.php?title=Zimbra_Releases/8.7.0[release notes]
information before upgrading.
endif::z9[]
...
* Ubuntu 18.04 LTS Server Edition (64-bit) (Beta beginning with 8.8.12)
