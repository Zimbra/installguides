...
NOTE: _The screen shots are examples of the {product-name} installation
...
+
--
NOTE: _As the installation proceeds, press_ *Enter* _to accept the
...
+
--
NOTE: For the cross mailbox search feature, install the {product-short} Archive
...
[IMPORTANT]
The {modern-client} does not currently support Zimbra Web Application Server Split configuration.
