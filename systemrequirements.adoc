...
Windows Vista SP 2, Windows 7, Windows 8 or Windows 10 with
...
Mac OS X 10.5, 10.6, 10.7, 10.8, 10.9, 10.10, or 10.11 with one of the following:
...
* Windows Vista SP 2, Windows 7 with Outlook Express 6, Outlook
...
support Microsoft Outlook 2007.
